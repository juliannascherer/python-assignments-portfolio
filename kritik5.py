...
def isInside(x1, y1, x2, y2, x3, y3, x, y):
    ...
    #returning true or false on whether the point is within the initial triangle
    return A == A1 + A2 + A3
...
for i in range(num_steps):
    ...
    next_vertex = vertices[random_number]
    ...
    previous_coordinate = points [-1]
    next_point_x = (previous_coordinate[0] + next_vertex[0])/2
    next_point_y = (previous_coordinate[1] + next_vertex[1])/2
